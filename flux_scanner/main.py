...
from flux_scanner.styles import THEME, BRAND_COLOR, SUCCESS_COLOR, WARNING_COLOR, ERROR_COLOR, NOISE_COLOR
from flux_scanner.engine import ReachabilityEngine, Vulnerability, Ecosystem

app = typer.Typer(
    help="Flux-Scanner: Multi-language Supply Chain Security & Risk Analysis",
...
def scan_logic(path: Path, severity: str):
    console.print(Panel(
        f"[brand]Flux-Scanner[/] [dim]v1.0.0 - Security & Risk Analysis Utility[/]\n"
